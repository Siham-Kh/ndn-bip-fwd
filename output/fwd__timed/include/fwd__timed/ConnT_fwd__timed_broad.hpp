#ifndef FWD____TIMED_CONNT__FWD____TIMED__BROAD_HPP_
#define FWD____TIMED_CONNT__FWD____TIMED__BROAD_HPP_
...
class ConnT_fwd__timed_broad : public Connector {
public:
    ConnT_fwd__timed_broad(const string &name, QPR_fwd__timed_trans &s, QPR_fwd__timed_trans &r);
    virtual ~ConnT_fwd__timed_broad();
...
private:
    ...
    // Interactions
    // build for s,r
    Inter_fwd__timed_broad *_i__s_r;



    mutable vector<Interaction *> definedInteractions;
};
#endif // FWD____TIMED_CONNT__FWD____TIMED__BROAD_HPP_
